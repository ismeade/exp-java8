...
//        numberList.parallelStream().filter((Integer i) -> i % 2 == 0).collect(Collectors.toList());
    ...
    public void test3() {
        System.out.println("Sequential sum done in: " + measureSumPerf(SimpleStreamExp::rangedSum, 10_000_000) + " msecs");
    }

    public static void main(String[] args) {
        new SimpleStreamExp().test3();
    }
